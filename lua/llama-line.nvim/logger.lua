...
function log:warn(msg)
  ...
  vim.api.nvim_notify(self.__notify_fmt(msg), vim.log.levels.WARN, { title = "LlamaLine" })
end
...
function log:error(msg)
  ...
  vim.api.nvim_notify(self.__notify_fmt(msg), vim.log.levels.ERROR, { title = "LlamaLine" })
end
